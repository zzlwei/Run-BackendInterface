  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="userlist" border stripe>
        ...
        <el-table-column label="任务奖励" prop="taskReward"></el-table-column>
    ...
    <el-dialog title="修改用户" :visible.sync="editDialogVisible" width="50%" @close="editDialogClosed">
      <el-form :model="editForm" :rules="editFormRules" ref="editFormRef" label-width="70px">
        ...
        <el-form-item label="任务奖励" prop="reward">
          <el-input v-model="editForm.reward"></el-input>
        </el-form-item>
        <el-form-item label="任务时间" prop="time">
...
export default {
  ...
  methods: {
    async getUserList() {
      const { data: res } = await this.$http.get("/GameTaskQuery/Select", {
    ...
    async showEditDialog(id) {
      // console.log(id)
      const { data: res } = await this.$http.get("/GameTaskQuery/SelectById?id=" + id);
      if (res.code != 0) {
    ...
    async removeUserById(id) {
      ...
      const { data: res } = await this.$http.get("/GameTaskDelete/ById?id=" + id);  
